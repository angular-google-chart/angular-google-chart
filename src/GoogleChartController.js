...
(function() {
    ...
    GoogleChartController.$inject = ['$scope', '$element', '$attrs', '$injector', 'FormatManager', '$timeout', '$window', '$rootScope', 'googleChartApiPromise'];

    function GoogleChartController($scope, $element, $attrs, $injector, FormatManager, $timeout, $window, $rootScope, googleChartApiPromise) {
        var self = this;
        var $google;
        var resizeHandler, wrapperListeners = {},
            formatManager,
            chartListeners = {},
        ...
        function setupAndDraw() {
            ...
            if (!formatManager) {
                formatManager = new FormatManager($google);
            }
